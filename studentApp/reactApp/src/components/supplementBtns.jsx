...
export default class SupBtns extends React.Component {
  ...
  render(){
    ...
    const downloadRaw = <Link to={"/back/supplement/rest/raw/"+this.props.id} className="btn-floating btn-medium waves-effect waves-light raw darken-3" target="_blank">
